			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="user-info">
						...
						<!--头像 -->
						<form class="am-form am-form-horizontal" method="post" action="../php/addData.php" enctype="multipart/form-data" id="form">
						...
						<div class="info-main">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input type="text" disabled = "disabled" id="user-name2" placeholder="<?php 
											if($_SESSION['username']) {
												echo $_SESSION['username'];
								...
								<div class="am-form-group">
									...
									<input type="text" id="user-name2" placeholder="age" name="age" style="width: 640px;margin-left:85px;">
